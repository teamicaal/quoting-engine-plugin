...
4. The quoting engine will automatically open in a new tab on devices `<768px` wide wide. To change the redirect width you can add the following attribute `data-redirect-width="768"`
